...
<body class="background">
	...
	<?php
		...
		echo "
		<div class='gif'>
				<img src='img/thinking3.gif' alt='thinkingsun' style='height:25%; width:25%;'>
			</div> 
		";
	?>
